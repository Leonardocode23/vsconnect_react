...
function PerfilUsuario() {
    ...
    const [listaSkils, setListaSkills] = useState<string[]>([])
            ...
            <div className="container container_perfil_dev">
                <div className="perfil_dev_conteudo">
                    ...
                    <div className="topo_dev">
                        <img src={"http://localhost:3000/static/" + foto} alt={"Foto de perfil de Thiago Nascimento" + nome} />
                        <h2>{nome}</h2>
                    </div>
                    ...
                    <div className="techs">
                        ...
                        <div className="lista_skills">
                            {
                                listaSkils.map( (skill: any, index:number ) => {
